...
if (!interactions.includes("play.disabled = true") || !interactions.includes("play.disabled = false")) throw new Error("Play-button states are incomplete.");
...
if (!skin.includes('data-play-state="locked"') || !skin.includes('data-play-state="completed"')) throw new Error("Locked and replay action styling is incomplete.");
...
console.log("Menu V3 synchronized interaction contract passed after the Lot 4 iPhone review.");
