...
for (const decorator of requiredDecorators) {
  if (!components.includes(`function ${decorator}`)) {
    throw new Error(`Menu V3 decorator missing: ${decorator}.`);
  }
}
...
if (!shell.includes('VERSION = "0.32.1-lot3.2"')) throw new Error("Menu V3 shell is not running the active Lot 3.2 version.");
...
const skinIndex = index.indexOf("menu-v3.skin.css?v=0.32.1");
...
console.log("Menu V3 component contract passed during Lot 3.2.");
