# Roadmap — Rightbound Roguelite

## Phase 1 — Prototype de combat

- [x] Déplacement automatique.
- [x] Combat automatique.
- [x] Saut avec fenêtre d’esquive.
- [x] Trois compétences temporaires.
...
- [ ] Sélection de trois compétences avant le niveau.
